...
void helpLegend_update(uint8_t nextState) 
{
...
void helpDoSlideRotate_update(uint8_t nextState)
{
...
void helpRotateSlide_update() 
{
    helpLegend_update(gsInitHelpRotateSlide2);
}

//ACTIONS SLIDE + ROTATE
void helpRotateSlide2_update() 
{
    helpDoSlideRotate_update(gsInitTitle);
}

//LEGEND + FINISHLEVEL STATE
void helpRotate_update()
{
    helpLegend_update(gsInitHelpRotate2);
}

//ACTIONS ROTATE
void helpRotate2_update()
{
    helpDoSlideRotate_update(gsInitTitle);
}

//LEGEND STATE
void helpSlide_update()
{
    helpLegend_update(gsInitHelpSlide2);
}

//ACTIONS SLIDE
void helpSlide2_update()
{
    helpDoSlideRotate_update(gsInitTitle);
}
